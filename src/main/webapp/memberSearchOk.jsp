...
<body>
	...
	<%
		...
		try {
			...
			while (rs.next()) {
					sid = rs.getString("member_id");
					String spw = rs.getString("member_pw");
					String sname = rs.getString("member_name");
					String semail = rs.getString("member_email");
					String sdate = rs.getString("member_date");
			
				out.println("***** 조회된 회원 정보 *****<br>");
				out.print(sid + " / " + spw + " / " +semail + " / " + sname + " / " + sdate );
				}
			if (sid == null){
			...
			if (rs.next()){ // 아이디가 존재 
				do {
					String sid = rs.getString("member_id");
					String spw = rs.getString("member_pw");
					String sname = rs.getString("member_name");
					String semail = rs.getString("member_email");
					String sdate = rs.getString("member_date");
